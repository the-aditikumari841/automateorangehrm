...
public class JobPage {
	...
	public boolean doesAlreadyExists(String job) {
		try {
			WebElement jobElement = findExistenceByXPATH(
					"//div[contains(@class, 'oxd-table-row oxd-table-row--with-border')]/div[contains(@class, 'oxd-table-cell oxd-padding-cell')]/div[contains(text(), '"
							+ job + "')]");
		...
		if (doesAlreadyExists(job)) {
			WebElement deleteButton = findExistenceByXPATH(
					"//div[contains(@class, 'oxd-table-row--with-border')]/div[contains(@class, 'oxd-padding-cell')]/div[contains(text(), '"
							+ job + "')]/../following-sibling::div//i[contains(@class, 'bi-trash')]");
	...
	public void edit(String job) {
		if (doesAlreadyExists(job)) {
			WebElement editButton = findExistenceByXPATH(
					"//div[contains(@class, 'oxd-table-row--with-border')]/div[contains(@class, 'oxd-padding-cell')]/div[contains(text(), '"
							+ job + "')]/../following-sibling::div//i[contains(@class, 'bi-pencil-fill')]");
